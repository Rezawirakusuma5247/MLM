          ...
          <div class="col-10 mx-auto">
            <div class="card card-primary card-outline" >
              <div class="card-header">
                <h2 class=" text-lg-center font-weight-bold">UHH OHH?</h2>
              </div>
              <div class="card-body">
                <h3 class="text-lg-center font-italic">Sepertinya anda belum terdaftar di rank?</h3>
                <h5 class="text-lg-center">tekan link di bawah ini untuk daftar</h4>
              </div>
                    </div>
                  </div>
              </div>
              </div>
              <a href="{{ route('vals.form.create') }}" class="btn btn-block btn-primary col-md-2 mx-auto">Daftar</a>
        </div>
      </div>
    </div>
