...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ route('welcome') }}" class="h1"><b>MLM</b> Website</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Halaman <b>Register</b></p>
          ...
          <div class="input-group mb-3">
            <select name="parent_id" class="form-control">
                ...
                @foreach($users as $user)
                    <option value="{{ $user->codes }}">{{ $user->codes }}</option>
                @endforeach
            </select>
            <div class="input-group-append">
                <div class="input-group-text">
            ...
            <div class="input-group mb-3">
                <input type="number" name="number" class="form-control" placeholder="No Telp" value="{{ old('number') }}">
                <div class="input-group-append">
                  <div class="input-group-text">
                    <span class="fas fa-envelope"></span>
                  </div>
